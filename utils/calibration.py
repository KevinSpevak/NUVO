...
if __name__ == "__main__":
    #capture_calibration_images(2, (8, 6), "data/calibration/right/")
    K, dist = generate_camera_intrinsics("data/calibration/left/", (8, 6))
    pickle.dump({"K": K, "dist": dist}, open("data/calibration/intrinsics_left.p", "wb"))
    K, dist = generate_camera_intrinsics("data/calibration/right/", (8, 6))
