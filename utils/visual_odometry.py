...
class Odometer:
    ...
    # requires StereoCameraPair object from utils/camera.py
    def __init__(self, stereo_camera_pair):
        self.stereo = stereo_camera_pair
...
class VisualOdometryError(Exception):
